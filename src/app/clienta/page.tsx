  ...
  const features = [
    {
      ...
      description: 'A role-aware home screen that gives you instant visibility into open tickets, SLA compliance, MRR, account health, and agent performance. Smart alerts flag at-risk accounts, unresolved incidents, and pending approvals.',
      points: [
        'Real-time KPIs: open tickets, first response time, SLA compliance, MRR',
        'Breakdown charts by status, priority, channel, department, and assignee',
        'Monthly trend tracking across the last 6 months',
    ...
    },
    {
      ...
      subtitle: '360° customer view',
      description: 'Full B2B account profiles with health scores, usage metrics, subscriptions, invoices, and linked contacts. Proactively spot at-risk accounts before they churn with automated health scoring and trend tracking.',
      points: [
        'Health scoring with event history and trend visualization',
        'Contact roles: Decision Maker, Billing, Technical, End User',
        'Usage and billing visibility with MRR tracking',
        'Renewal tracking and churn risk scores with at-risk revenue alerts',
      ],
    },
    {
      icon: MessageSquare,
      gradient: 'from-emerald-500 to-teal-500',
      title: 'Tickets & SLA Engine',
      subtitle: 'Resolve faster',
      description: 'Full support ticketing with SLA tracking, priority, categories, departments, assignments, and conversation timelines. Configurable SLA policies with response time, resolution time, and automatic escalation tracking.',
      points: [
        'Ticket workflow: statuses, priorities, assignments, categories, custom fields',
        'SLA engine: automated tracking, escalation, and compliance monitoring',
        'Conversation threads with internal notes for agent handoffs',
        'Post-ticket CSAT and account-level NPS with trend analysis',
      ],
    },
    {
      icon: Headphones,
      gradient: 'from-orange-500 to-red-500',
      title: 'Unified Inbox & Chat Widget',
      subtitle: 'All channels, one place',
      description: 'All conversations from email, chat, WhatsApp, SMS, social media, VoIP, Telegram, and API in one unified inbox. Plus an embeddable live-chat widget with 30+ configuration options that deploys with a single script tag.',
      points: [
        'Omni-channel: Email, VoIP, WhatsApp, Facebook, Instagram, SMS, Telegram, Web Chat, API',
        'Embeddable widget: pre-chat forms, proactive messages, bot auto-reply, typing indicators',
        'Working hours and offline mode with lead capture',
        'Emoji, ratings, satisfaction surveys, and file sharing built in',
      ],
    },
    {
      icon: Activity,
      gradient: 'from-yellow-500 to-amber-500',
      title: 'Incidents, Bugs & Feature Requests',
      subtitle: 'SaaS operations',
      description: 'Track, triage, and resolve incidents with severity levels and affected account tracking. Log and manage bugs with status workflows. Let customers vote on feature requests with prioritization and status tracking.',
      points: [
        'Incident management with severity levels and affected account tracking',
        'Bug tracking with severity, status workflow, and product linkage',
        'Customer-driven feature voting with prioritization and status updates',
        'Renewal tracking and churn prevention with risk scoring',
      ],
    },
    {
      icon: BarChart3,
      ...
      description: '8+ key KPIs with breakdown charts by status, priority, source channel, department, and assignee. Monthly trend analysis, CSV export for deeper analysis, and automated account health scoring.',
      points: [
        'KPI dashboard: open tickets, first response, SLA compliance, MRR, health scores',
        'Breakdown charts by status, priority, channel, department, assignee',
        'Monthly trend tracking to spot patterns and measure improvement',
        'CSV export for analysis in Excel, Google Sheets, or BI tools',
      ],
    },
    {
      icon: Layers,
      ...
      description: 'Each tenant gets their own isolated workspace with independent data, users, and settings. White-label ready with custom branding, logos, colors, and feature flags to sell different tiers without code changes.',
      points: [
        'Data isolation: row-level security guarantees your data stays yours',
        'Feature flags: enable or disable 15 modules per tenant',
        'Custom branding: logos, colors, widget, and portal customization',
        'Role-based access with 10 predefined roles and 50+ granular permissions',
      ],
    },
    {
      icon: FileText,
      ...
      subtitle: 'Empower your customers',
      description: 'Self-service articles with categories, visibility control, and portal access for customers. Customers can submit tickets, browse the knowledge base, view billing, take surveys, and manage their profile — all from a branded portal.',
      points: [
        'Knowledge base with categories and visibility control',
        'Customer portal: submit tickets, view billing, take surveys',
        'CSAT and NPS surveys built into the portal experience',
        'Reduces ticket volume by empowering customers to self-serve',
      ],
    },
  ]

  const securityPoints = [
    'Row-level security guarantees data isolation per tenant',
    'Role-based access with 10 roles and 50+ permissions enforced at UI and database level',
    'Full audit trail of who changed what, when, across all entities',
    'Modern stack: Next.js, Supabase, TypeScript — fast, type-safe, scalable',
    'Custom fields: 6 field types (text, number, date, boolean, select, multi-select)',
    'Email templates and i18n support (English + Arabic with RTL)',
  ]

  const regionItems = [
    { icon: Globe, label: 'English & Arabic — bilingual', desc: 'Full RTL layout support out of the box' },
    { icon: Zap, label: 'Ready to sell', desc: 'Feature flags, tenant management, and pricing tiers built in' },
    { icon: Shield, label: 'Enterprise security', desc: 'Row-level security, audit logs, role-based access' },
    { icon: Layers, label: 'Embeddable chat widget', desc: 'One script tag — 30+ config options, 5 languages' },
  ]
          ...
          <div className="max-w-3xl mx-auto text-center" ref={heroRef}>
            ...
            >
              ...
              <motion.p initial={{ opacity: 0, y: 15 }} animate={heroInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.25 }} className="text-gray-400 text-lg leading-relaxed max-w-2xl mx-auto mb-4">
                A multi-tenant CRM platform built for B2B SaaS companies. Unify customer service, support tickets, live chat, account health, incidents, and billing visibility — all from a single dashboard.
              </motion.p>
              ...
              <motion.p initial={{ opacity: 0, y: 15 }} animate={heroInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5, delay: 0.3 }} className="text-gray-500 text-base leading-relaxed max-w-xl mx-auto mb-10">
                Whether you&apos;re a startup or an enterprise, Clienta scales with your business. Each tenant gets their own isolated workspace with configurable features, custom branding, and granular role-based access control.
              </motion.p>
            ...
            <div className="glass-card rounded-2xl p-8 border-gradient">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 font-medium">Languages (EN + AR)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-60px' }} transition={{ duration: 0.5 }} className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                ...
                <span className="text-shimmer">run customer operations</span>
              </h2>
              <p className="text-gray-400 text-lg max-w-xl mx-auto">
                Clienta covers the full lifecycle — from onboarding customers and resolving tickets to tracking incidents and preventing churn.
              </p>
            </motion.div>
              ...
              <div className="glass-card rounded-3xl p-8 lg:p-10 relative overflow-hidden border-gradient">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white">Why Clienta?</h3>
                      <p className="text-xs text-cyan-400">Built for modern SaaS teams</p>
                    </div>
                  </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-cyan-400">Learn more about Clienta</p>
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <a href="/Clienta-Presentation.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:border-cyan-500/30 transition-all hover:bg-white/[0.04] group">
                      ...
                      <div>
                        <p className="text-sm font-medium text-white group-hover:text-cyan-300 transition-colors">Platform Overview</p>
                        <p className="text-xs text-gray-500">Full CRM platform features & architecture</p>
                      </div>
                    </a>
                    <a href="/Clienta-Tenant-Presentation.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:border-cyan-500/30 transition-all hover:bg-white/[0.04] group">
                      <FileText className="w-8 h-8 text-cyan-400 shrink-0" />
                      <div>
                        <p className="text-sm font-medium text-white group-hover:text-cyan-300 transition-colors">Tenant Guide</p>
                        <p className="text-xs text-gray-500">Your workspace & module walkthrough</p>
                      </div>
                    </a>
                  </div>
                </div>
              ...
              <div className="glass-card rounded-3xl p-8 lg:p-10 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white">Security & Administration</h3>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-60px' }} transition={{ duration: 0.6 }}>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
                Launch your customer platform today
              </h2>
              <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                Scalable. Customizable. Ready to sell. Start your free trial — no credit card required.
              </p>
